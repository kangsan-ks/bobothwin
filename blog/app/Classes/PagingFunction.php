	...
	function paging($totalCount, $thisPage, $link, $block = false, $showFast = false, $prevBtn = false, $nextBtn = false, $firstBtn = false, $endBtn = false) {
		...
		if($totalPage > 1) {
			...
			if($thisPage == 1) {
				...
				if($prevBtn == "") {
					$prevBtn = '<li tabindex="0" class="paginate_button previous" onclick="javascript:' . $link . '(' . ($thisPage - 1) . ')"><a href="#none" title="이전" class="prev"><i class="fas fa-angle-left"></i></a></li>';
				} else {
					$prevBtn = '<li tabindex="0" class="paginate_button previous" onclick="javascript:' . $link . '(' . ($thisPage - 1) . ')">' . $prevBtn . '</span>';
				}
			}
			...
			if($thisPage == 1) {
				...
				if($firstBtn == "") {
					$firstBtn = '<li tabindex="0" class="paginate_button previous" onclick="javascript:' . $link . '(1)"><a href="#none" title="이전" class="prev"><i class="fas fa-angle-double-left"></i></a></li>';
				} else {
			...
			if($thisPage >= $totalPage) {
				...
				if($nextBtn == "") {
					$nextBtn = '<li tabindex="0" class="paginate_button next" onclick="javascript:' . $link . '(' . ($thisPage + 1) . ')"><a href="#none" title="다음" class="next"><i class="fas fa-angle-right"></i></a></li>';
				} else {
					$nextBtn = '<li tabindex="0" class="paginate_button next" onclick="javascript:' . $link . '(' . ($thisPage + 1) . ')">' . $nextBtn . '</span>';
				}
			}
			...
			if($thisPage >= $totalPage) {
				...
				if($endBtn == "") {
					$endBtn = '<li tabindex="0" class="paginate_button next" onclick="javascript:' . $link . '(' . ($totalPage) . ')"><a href="#none" title="다음" class="next"><i class="fas fa-angle-double-right"></i></a></li>';
				} else {
					$endBtn = '<li tabindex="0" class="paginate_button next" onclick="javascript:' . $link . '(' . ($totalPage) . ')">' . $nextBtn . '</span>';
				}
			}
			...
			if($block == false) {
				...
				for($i = $start_view; $i <= $end_view; $i++) {
					if($i == $thisPage) {
						$paging .= '<li tabindex="0" class="paginate_button active"><a href="#none" class="active">' . $i . '</a></li>';
					} else {
						$paging .= '<li tabindex="0" class="paginate_button" onclick="javascript:' . $link . '(' . $i . ')"><a href="#none" class="">' . $i . '</a></li>';
					}
				}
			} 
